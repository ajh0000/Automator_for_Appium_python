...
class ParameTestCase(unittest.TestCase):
	def __init__(self,methodName= 'runTest',parame = None):
		...
		# self.setup_business = SetupBusiness(self.driver)
		# #-------------启动驱动-----------------
		# capabilites = {
		...
		# self.login_business = LoginBusiness(1,driver)
		# self.setup_business = SetupBusiness(1,driver)

class 登录功能(ParameTestCase):
	# def __init__(self):
	# 	ParameTestCase.__init__(self)
	...
	def setUpClass(cls):
		...
		cls.driver = cls.base_driver.Android_driver(0)
		cls.login_business = LoginBusiness(cls.driver)
		cls.setup_business = SetupBusiness(cls.driver)
	'''
...
class 设置功能(ParameTestCase):
	def __init__(self):
		ParameTestCase.__init__(self)
	# @classmethod
	# def setUpClass(cls):
	# 	print('this is Class Setup')
		# cls.setup_business = SetupBusiness(1,driver)
...
def get_suite():
	...
	suite.addTest(登录功能('Login_Startup'))
	suite.addTest(登录功能('Login_Go'))
	suite.addTest(登录功能('Login_user_error'))
	suite.addTest(登录功能('Login_PWD_error01'))
	suite.addTest(登录功能('Login_PWD_error02'))
	suite.addTest(登录功能('Login_Pass_Func'))
	# suite.addTest(设置功能('Setup_Go'))
	# suite.addTest(设置功能('Setup_PWD_Func'))
	# suite.addTest(设置功能('Setup_Center_Func'))
	# suite.addTest(设置功能('Setup_Pay_Func'))
	# suite.addTest(设置功能('Setup_Feendback_Func'))
	# suite.addTest(设置功能('Setup_About_Func'))
